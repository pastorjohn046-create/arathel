...
import { Users, CreditCard, Package, MessageSquare, ShieldAlert, Search, Plus, Trash2, Code, Wallet, Landmark, CheckCircle2 } from 'lucide-react';
...
export const AdminPanel: React.FC = () => {
  ...
  useEffect(() => {
    fetchUsers();
    const interval = setInterval(fetchUsers, 10000); // Poll users every 10s
